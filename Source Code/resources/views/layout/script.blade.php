...
<!-- Data Tables -->
  ...
  <script src="{{asset('asset/datatables/dataTables.bootstrap.min.js')}}"></script>

  <!-- Custom Data tables -->
  <script src="{{asset('asset/datatables/custom/custom-datatables.js')}}"></script>
  <script src="{{asset('asset/datatables/custom/fixedHeader.js')}}"></script>
