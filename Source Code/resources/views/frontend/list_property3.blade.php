...
<body>
    ...
    <div class="bg-grey">
        <div class="container">
            <div class="box-hotel">
               ...
               {{-- <div style="margin-left: 100%"><button type="button" class="btn btn-outline-danger">Danger</button></div> --}}
                <div class="vl-filter-hotel">
                    <form action="{{url('update/draft/bedroom')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-flex f-m align-items-start">
                            <div class="nav flex-column col-sm-4 nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                 ...
                                 <input type="text" class="form-control" name="name" value="{{@$select_room[0]->name}}" placeholder="Enter Name Room">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="boxincrease">
                                            <div class="">
                                                ...
                                                <input data-value class="butincre value" name="twin" value="{{@$select_room[0]->twin_bed}}" />
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="boxincrease">
                                            <div class="">
                                                <button data-decrease class="butincre minus" type="button"onclick="min_bed(1)">- </button>
                                                <input data-value class="butincre value" name="full" value="{{@$select_room[0]->full_bed}}" />
                                                <button data-increase class="butincre plus" type="button"  onclick="plus_bed(1)">+</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="boxincrease">
                                            <div class="">
                                                <button data-decrease class="butincre minus"type="button"onclick="min_bed(1)">- </button>
                                                <input data-value class="butincre value" name="queen" value="{{@$select_room[0]->queen_bed}}" />
                                                <button data-increase class="butincre plus"type="button" onclick="plus_bed(1)">+</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="boxincrease">
                                            <div class="">
                                                <button data-decrease class="butincre minus" type="button"onclick="min_bed(1)">- </button>
                                                <input data-value class="butincre value" name="king" value="{{@$select_room[0]->king_bed}}" />
                                                <button data-increase class="butincre plus"type="button" onclick="plus_bed(1)">+</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="boxincrease">
                                                <div class="">
                                                    ...
                                                    <input data-value class="butincre value" name="bath" value="{{@$select_room[0]->bathroom}}" />
                                        ...
                                        <div class="col-sm-5 mb-3">
                                            ...
                                            <div class="">
                                                <div class="boxincrease">
                                                    <div class="">
                                                        <button data-decrease class="butincre minus"type="button">- </button>
                                                        <input data-value class="butincre value" name="adult" value="{{@$select_room[0]->adult}}" />
                                                        <button data-increase class="butincre plus"type="button">+</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class=" mt-5">
                                    ...
                                    <div class="col-sm-12 mt-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="size" value="{{@$select_room[0]->size}}">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="file-upload" style="min-width: 200px;">
                                    <div>
                                        ...
                                        <input id="upFile" name="image_room[]" type="file" value="" multiple hidden>
                                ...
                                <div class="row justify-content-center mt-5">
                                    <div class="col-sm-4 ">
                                        <button  class="btn btn-outline-danger mt-3" style="width: 100%;" type="submit"><i class="fa fa-trash"></i> Room</button>
                                    </div>
                                    <div class="col-sm-4 ">
                                        <button  class="btn btn-outline-success mt-3" style="width: 100%;" type="submit"><i class="fa fa-save"></i> Update</button>
                                    </div>
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-sm-4 ">
                            <a href="{{url('partner/draft/list_property3/'.$poolvilla_id.'/'.$select_room[0]->id)}}">
                                <div class="btn-grey mt-3">Back</div>
                            </a>
                        </div>
                        <div class="col-sm-4 ">
                            <button  class="btn btn-outline-danger mt-3" style="width: 100%;" type="button" onclick="delete_room()"><i class="fa fa-trash"></i> Delete</button>
                        </div>
                        <div class="col-sm-4 ">
                            <button  class="btn btn-outline-success mt-3" style="width: 100%;" type="submit"><i class="fa fa-save"></i> Update</button>
                        </div>
  ...
  <div class="modal fade" id="show_add_room" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    ...
    <form action="{{url('partner/delete/room')}}" method="POST" id="delete_room">
        @csrf
        <input type="hidden" name="poolvilla_id" value="{{$poolvilla_id}}">
        <input type="hidden" name="room_id" value="{{$select_room[0]->id}}">
    </form>
