<div class="bg-footer">
    <div class="row justify-content-between">
        ...
        <div class="col-sm-4">
                    <ul class="">
                        <li class="nav-link non-scroll textft"><a href="{{ url(Session::get('lang').'/list_property1') }}">Add new Property</a></li>
                        <li class="nav-link non-scroll textft"><a href="{{ url(Session::get('lang').'/hotel_policy_refund') }}">Policy and refund</a></li>
                    </ul>
        </div>
