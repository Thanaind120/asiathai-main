<div class="bg-footer">
    <div class="row justify-content-between">
        <div class="col-sm-5">
           <img src="{{asset('assets_frontend/images/logo.svg')}}" class="logo-footer hotel">
        ...
        <div class="col-sm-4">
                    <ul class="">
                        <li class="nav-link non-scroll"><a href="{{url('signin_hotel')}}">Signin</a></li>
                        <li class="nav-link non-scroll"><a href="{{url('register_hotel')}}">Signup</a></li>
                        <li class="nav-link non-scroll"><a href="{{url('hotel_policy_refund')}}">Policy and refund</a></li>
                    </ul>
        </div>
