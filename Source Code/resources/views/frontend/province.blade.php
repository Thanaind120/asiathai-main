                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control orange-check check-in-out"
                                                        id="datepicker" type="text" placeholder="@lang('lang.date')" name="ci" value="{{ $today }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="for-destop">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">*@lang('lang.province')*</li>
                        </ol>
                    </nav>
                </div>
            </div>
        </div>
        <div class="head-text-index">@lang('lang.provinces') @lang('lang.most_popular_province') </div>
        ...
        <div class="row my-5">
            ...
            <div class="col-sm-4 col-6">
                <div class="frame-item box-destination">
                    <a href="{{ url(Session::get('lang').'/select-hotel/search?province='.$province.'&ci='.$ci.'&co='.$co.'&adult='.$adult.'&kid='.$kid.'&ro='.$ro) }}"
                        class="">
                        <img src="{{ ($val->city_image != '')? asset('assets_frontend/images/'.$val->city_image) : asset('assets_frontend/images/destination1.jpg') }}" class="img-des">
                        <div class="bottom-left">
                            <p class="name-text text-white">@if(Session::get('lang') == 'en') {{ $val->name_en }} @else {{ $val->name_th }} @endif</p>
                        </div>
                    </a>
                </div>
            </div>
