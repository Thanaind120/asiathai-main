            ...
            <div class="container p-5">
              <div class="row">
                <div class="col text-center">
                  ...
                  <a class="btn btn-warning text-white" href="{{url('Partner/Poolvilla/Index')}}">Finish</a>
                </div>
              </div>
            </div>
          </div>
...
<div class="modal fade" id="add_image" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        <form action="{{url('Partner/Poolvilla/Image/Update')}}" enctype="multipart/form-data" method="POST">
          @csrf
...
<input type="hidden" name="url_to_del" id="url_to_del" value="{{url('Partner/Poolvilla/Image/Delete/')}}">
