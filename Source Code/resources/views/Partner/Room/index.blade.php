...
<body>
              ...
              <div class="table-responsive ">
                ...
                <tbody>
                  ...
                  <a class="btn btn-primary text-white" href="{{url('Partner/Room/'.$l2->id.'/Discount')}}"> Discount</a> 
                    ...
                    <button class="btn btn-danger" onclick="confirm_delete('{{$l2->id}}')">	<i class="fas fa-trash-alt" ></i> Delete</button>
                    </td>
                  </tr>
                    @endforeach
                </tbody>
  ...
  <!-- form to delete -->
<form action="{{url('/room/delete')}}" method="POST" id="form_delete">
  @csrf
