   ...
   <div class="main-content">
    <section class="section">
      ...
      <div class="col-sm-4">
        ...
        <input class="form-control mt-2" type="number" name="price" placeholder="Input your price" value="{{@$list1->price}}" required>
        </div>
        <div class="col-sm-4">
        <div class="text-tiny text-grey text-start mt-3">Max Room </div>
        <input class="form-control mt-2" type="number" name="max_room" placeholder="Input your price" value="{{@$list1->max_room}}" required>
        </div>
              ...
              <div class="vl-filter-hotel  row col-12">
                  ...
                  <div class="text-medium text-grey text-bold mt-3">{{$f->facilities}}</div>
                      ...
                      <div class="form-check ">
                          <input class="form-check-input" type="checkbox" value="{{$i->id}}" name="icon[]" id="flexCheckDefault{{$i->id}}" @if(isset($icon_check[0]))checked @endif>
                          <label class="form-check-label" for="flexCheckDefault{{$i->id}}">{{$i->icon_name}}</label>
                      </div>
                      @endforeach
                    </div>
                  @endforeach
