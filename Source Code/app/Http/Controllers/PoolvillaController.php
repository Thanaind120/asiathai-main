...
class PoolvillaController extends Controller
{
    public function index(){
        ...
        $list1=Poolvilla::where('partner_id',$partner_id)->whereBetween('status',[0,1])->get();
    ...
    public function delete(Request $request){
        $list2=Poolvilla::where('id',$request->id)->first();
        $list2->status=3;
        $list2->save();
        return redirect()->to('Partner/Poolvilla/Index')->with('success','Delete Poolvilla success');
    }
