...
class InboxController extends Controller
{
    public function index(){
        ...
        $list1=Inbox::where('ref_sender_id',Auth::user()->id)->orderBy('updated_at','desc')->get();
//   dd($list1);
        $data=array(
            'list1'=>$list1,
            // 'list3'=>$list3,
        );
        return view('Partner.Inbox.index',$data);
    }
    ...
    public function save_form2(Request $request){
        ...
        $message->save();
        $inbox=Inbox::where('id',$request->ref_inbox_id)->first();
