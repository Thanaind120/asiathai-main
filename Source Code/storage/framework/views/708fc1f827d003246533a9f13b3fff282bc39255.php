                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="<?php echo e(url('backend/country/add')); ?>" class="btn btn-success "><i
                                    ...
                                    <table id="simpletable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if($check->page_edit == 1 || $check->page_view == 1 ||
                                                $check->page_delete == 1): ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%"><?php echo e($row->country_name); ?></td>
                                                <td style="width: 35%">
                                                    <img src="<?php echo e(asset('frontend_assets/country_image/'.$row->country_image)); ?>"
                                                        height="150px" alt="">
                                                </td>
                                                <?php if($check->page_edit == 1 || $check->page_view == 1 ||
                                                $check->page_delete == 1): ?>
                                                <td style="width: 20%">
                                                    ...
                                                    <a class="btn btn-warning text-white"
                                                        href="<?php echo e(url('backend/country/edit/'.$row->country_id)); ?>"><i
                                                    ...
                                                    <a class="btn btn-info text-white"
                                                        href="<?php echo e(url('backend/country/city/'.$row->country_id)); ?>"><i
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/backend/country/backend_country.blade.php ENDPATH**/ ?>