...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="<?php echo e(url('backend/admin/add-role')); ?>" class="btn btn-success"><i
                            ...
                            <div class="card-body ">
                                <div class="table-responsive">
                                    <table id="simpletable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $role; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-warning text-white"
                                                        href="<?php echo e(url('backend/admin/update_role/'.$u->id)); ?>"><i
                                                            class="fa fa-pencil-square-o"></i> Edit</a>
                                                    <?php endif; ?>
                                                    <!-- <?php if($check->page_delete == 1): ?>
                                                    <button class="btn btn-danger"
                                                        onclick="confirm_delete('<?php echo e($u->id); ?>')">Delete</button>
                                                    <?php endif; ?> -->
                                                </td>
                                                <?php endif; ?>
                                            </tr>
    ...
    <form action="<?php echo e(url('/backend/role_reset')); ?>" method="POST" id="reset_password">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="id" id="id_reset">
    </form>
    <!-- form delete -->
    <form action="<?php echo e(url('backend/role_profile/delete')); ?>" method="POST" id="delete_form">
        <?php echo csrf_field(); ?>
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/backend/admin/manage_role/index.blade.php ENDPATH**/ ?>