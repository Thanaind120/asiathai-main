...
<body>
    ...
    <section class="section">
      ...
      <div class="section-body ">      
        <div class="card col-12" >             
          ...
          <form action="<?php echo e(url('Partner/Poolvilla/Form2/save')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if(!isset($list1)): ?>
            ...
            <div class="">
              <div class="row">
              <!-- <div class="col-sm-6">
                  <div class="text-medium text-grey text-bold mt-3">Near by Landmark</div>
                  <div class="col-12 mt-3">
                    <input type="text" name="near_by_lanmark1" class="form-control" value="@$list1->near_by_lanmark1" Placeholder="">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="text-medium text-grey text-bold mt-3">More about villas (Thai language)</div>
                  <div class="col-12 mt-3">
                    <textarea rows="10" class="form-control mb-3" type="text" name="more_about_th" ><?php echo e(@$list1->more_about_th); ?></textarea>
                  </div>
                </div>    
              </div> -->
            </div>
                <div class="col-sm-6">
                  ...
                  <div class="col-12 mt-3">
                    <textarea rows="10" class="form-control mb-3"id="textAreaExample1" type="text" name="more_about_en"><?php echo e(@$list1->more_about_en); ?></textarea>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="text-medium text-grey text-bold mt-3">More about villas (Thai language)</div>
            ...
            <div class="mb-3">
              ...
              <div class="col-12 mt-3">
                ...
                <div class="row mb-3" id="add_quest">
                  ...
                  <?php else: ?>
                    ...
                    <?php $__currentLoopData = $list2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2 =>$l2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php ($count_l2=count($list2)); ?>
                    <input type="hidden" value="<?php echo e($count_l2); ?>" id="set_count">
                    <div class="col-sm-5 quest<?php echo e($item2); ?>" >                   
                      <div class="text-tiny text-bold"> <input type="checkbox" id="check_del<?php echo e($item2); ?>" value="<?php echo e($item2); ?>"> Questions (English language)</div>
                      <input class="form-control mb-3" type="text" name="quest_en[]" value="<?php echo e(@$l2->question_en); ?>">
                    </div>
                    <div class="col-sm-5 quest<?php echo e($item2); ?>">
                      <div class="text-tiny text-bold">Questions (Thai language)</div>
                      <input class="form-control mb-3" type="text" name="quest_th[]" value="<?php echo e(@$l2->question_th); ?>">
                    </div>
                 
                    <div class="col-sm-5 quest<?php echo e($item2); ?>">
                      <div class="text-tiny text-bold">Answer (English language)</div>
                      <textarea rows="10" class="form-control mb-3" type="text" name="ans_en[]"><?php echo e(@$l2->ans_en); ?></textarea>
                    </div>
                    <div class="col-sm-5 quest<?php echo e($item2); ?>">
                      <div class="text-tiny text-bold">Answer (Thai language)</div>
                      <textarea rows="10" class="form-control mb-3" type="text" name="ans_th[]"><?php echo e(@$l2->ans_th); ?></textarea>
                    </div>
              ...
              <div class="vl-filter-hotel ml-3">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="breakfast" value="1" id="flexRadioDefault1" <?php if($list1->breakfast==1): ?> checked <?php endif; ?>>
                    <label class="form-check-label" for="flexRadioDefault1">
                     Yes
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="breakfast" value="0" id="flexRadioDefault2" <?php if($list1->breakfast==0): ?> checked <?php endif; ?>>
              ...
              <div class="vl-filter-hotel ml-3">
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="parking" value="1" <?php if($list1->parking==1): ?> checked <?php endif; ?>>
                    <label class="form-check-label" for="flexRadioDefault1">
                     Yes, free
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="parking" value="2" id="flexRadioDefault2" <?php if($list1->parking==2): ?> checked <?php endif; ?>>
                    <label class="form-check-label" for="flexRadioDefault2">
                      yes, paid
                    </label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="parking" value="0" id="flexRadioDefault3" <?php if($list1->parking==0): ?> checked <?php endif; ?>>
              ...
              <div class="vl-filter-hotel">
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" value="1" name="languages[]" <?php if(@$lang[0]->language==1): ?> checked <?php endif; ?>>
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" value="2" name="languages[]" <?php if(@$lang2[0]->language==2): ?> checked <?php endif; ?>>
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" value="3" name="languages[]" <?php if(@$lang3[0]->language==3): ?> checked <?php endif; ?>>
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" value="4" name="languages[]" <?php if(@$lang4[0]->language==4): ?> checked <?php endif; ?>>
                  ...
                  <div class="form-check">
                    ...
                    <input class="form-check-input" type="checkbox" value="5" name="languages[]" <?php if(@$lang5[0]->language==5): ?> checked <?php endif; ?>>
            ...
            <div class="container p-5">
                <div class="row">
                  <div class="col text-center">
                    <a class="btn btn-secondary" type="button" href="<?php echo e(url('Partner/Poolvilla/'.$list1->id.'/Edit')); ?>">Back</a> 
  ...
  function add_quest1(){
    count_quest++;
    // alert(count_quest);
    console.log('เพิ่มที่: '+count_quest)
 $( "#add_quest" ).append( ' <div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold"><input type="checkbox" id="check_del'+count_quest+'" value="1"> Questions (English language)</div><input class="form-control mb-3" type="text" name="quest_en[]"></div><div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Questions (Thai language)</div><input class="form-control mb-3" type="text" name="quest_th[]"></div>    <div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Answer (English language)</div><textarea rows="3" class="form-control mb-3" type="text" name="ans_en[]"></textarea></div><div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Answer (Thai language)</div><textarea rows="3" class="form-control mb-3" type="text" name="ans_th[]"></textarea></div>');
  console.log( '<div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold"><input type="checkbox" id="check_del'+count_quest+'" value="1"> Questions (English language)</div><input class="form-control mb-3" type="text" name="quest_en[]"></div><div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Questions (Thai language)</div><input class="form-control mb-3" type="text" name="quest_th[]"></div>    <div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Answer (English language)</div><textarea rows="3" class="form-control mb-3" type="text" name="ans_en[]"></textarea></div><div class="col-sm-5 quest'+count_quest+'"><div class="text-tiny text-bold">Answer (Thai language)</div><textarea rows="3" class="form-control mb-3" type="text" name="ans_th[]"></textarea></div>');
  }

  function delete_quest(){
    let text = "โปรดยืนยันการทำรายการ!";
    var check_co=count_quest;
  if (confirm(text) == true) {
    for(let i=0;i<=check_co;i++){     
      // console.log('check_co: '+check_co);
      // console.log('เช็ก i นอก if: '+i)
      // $("#chk1").prop("checked")
     if($('#check_del'+i).prop("checked") ){
      // console.log('เช็ก i ใน if: '+i)
      // console.log('ลบที่: '+count_quest)
         $( '.quest'+i ).remove();
         count_quest--;
     }
   }
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/Partner/Poolvilla/form2.blade.php ENDPATH**/ ?>