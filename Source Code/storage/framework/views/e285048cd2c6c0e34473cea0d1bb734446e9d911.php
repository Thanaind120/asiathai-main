    ...
    <section class="section">
      ...
      <div class="section-body ">      
        <div class="card col-8" >             
          ...
          <form action="<?php echo e(url('backend/banking_system/save')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if(!isset($bank)): ?>
            ...
            <div class="form-group row ml-4 mt-5">           
              ...
              <div class="col-md-8">
                  <input class="form-control" type="text" value="<?php echo e(@$bank[0]->account_name); ?>" name="account_name" required>
              </div>
          </div>   
            <div class="form-group row ml-4 mt-5">           
              <label for="firstname" class="col-md-2 col-form-label">Account Number:</label>
              <div class="col-md-8">
                  <input class="form-control" type="text" value="<?php echo e(@$bank[0]->account_number); ?>" name="account_number" required>
              </div>
          </div>     
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/backend/banking_system/form.blade.php ENDPATH**/ ?>