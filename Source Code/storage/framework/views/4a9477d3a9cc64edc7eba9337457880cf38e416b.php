        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        <div>
                            <a style="cursor:pointer" class="btn-booking btn_show active"><?php echo app('translator')->get('lang.ready_to_reviews'); ?></a>
                            <a style="cursor:pointer" class="btn-booking btn_show"><?php echo app('translator')->get('lang.published'); ?></a>
                        </div>
                        <div>
                            <div class="boxshow">
                                ...
                                <?php if($val->status == 0): ?>
                                <form action="<?php echo e(url(Session::get('lang').'/review/id='.$val->id)); ?>" method="POST"
                                    ...
                                    <div class="card booking my-3" href="#">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-9">
                                                <div class="card-body">
                                                    <div class="name-text"><?php echo e($val->name_hotel); ?></div>
                                                    <div class="text-orange text-review mt-3 mb-2"><?php echo app('translator')->get('lang.on_a_scale'); ?></div>
                                                    ...
                                                    <div class="mt-3">
                                                        <textarea class="form-control" id="exampleFormControlTextarea1"
                                                            name="review" rows="3"
                                                            placeholder="<?php echo app('translator')->get('lang.write_a_review'); ?>"></textarea>
                                                    </div>
                                                    <div class="row" id="hidden_one" style="display: none;">
                                                        <div class="col">
                                                            <div class="form-group mt-3">
                                                                <label for=""><?php echo app('translator')->get('lang.upload_images'); ?></label>
                                        ...
                                        <div class="vl-top-book">
                                            <div class="row">
                                                <div class="col-sm-9" style="text-align: right;">
                                                    <font color="orange">* <?php echo app('translator')->get('lang.after_reviewing'); ?></font>
                                                </div>
                                                <div class="col-sm-3">
                                                    <button type="submit" class="btn-blue"><?php echo app('translator')->get('lang.review'); ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <br>
                                <br>
                                <h4><?php echo app('translator')->get('lang.information_hasbeen_published'); ?></h4>
                                <?php endif; ?>
                            </div>
                            <div class="boxshow">
                                ...
                                <div class="card booking my-3" href="#">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-10 col-8">
                                                        <div class="name-text"><?php echo e($val["name_".Session::get('lang')]); ?> (<?php echo e($val->name); ?>)</div>
                                                    </div>
                                                    <div class="col-sm-2 col-4">
                                                        <div class="point-badge"><?php echo e($val->rating); ?></div>
                                                    </div>
                                                </div>
                                                <div class="mt-3">
                                                    <div class="text-tiny text-grey"><?php echo e($val->review); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="vl-top-book">
                                        <div class="row">
                                            ...
                                            ?>
                                            <div class="col-sm-3">
                                                <a type="submit" class="btn-blue" href="<?php echo e(url(Session::get('lang').'/select-rooms/'.$poolvilla->id.'/'.$check_in.'/'.$check_out.'/adult='.$a_from.'/kid='.$k_from.'/room='.$ro)); ?>"><?php echo app('translator')->get('lang.see_room'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/frontend/review.blade.php ENDPATH**/ ?>