                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-8 col-10">
                        ...
                        <ul class="nav-list">
                            ...
                            <li class="nav-link scroll"><a></a></li>
                            <li class="nav-link scroll"><a href="<?php echo e(url('/'.Session::get('lang'))); ?>"><?php echo app('translator')->get('lang.home'); ?></a></li>
                            <li class="nav-link scroll"><a href="<?php echo e(url(Session::get('lang').'/tourist-attraction')); ?>"><?php echo app('translator')->get('lang.tourist_attraction'); ?></a>
                            </li>
                            ...
                            <li class="nav-link scroll"><a href="<?php echo e(url(Session::get('lang').'/register')); ?>"><?php echo app('translator')->get('lang.register'); ?></a></li>
                            <li class="nav-link scroll"><a href="<?php echo e(url(Session::get('lang').'/signin')); ?>"><i
                            ...
                            <li class="nav-link non-scroll">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu lang" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="<?php echo e(url('en').session()->get('prefix')); ?>"><img src="<?php echo e(asset('assets_frontend/images/lang-en.png')); ?>" class="lang"><?php echo app('translator')->get('lang.en'); ?></a></li>
                                    </ul>
                                </div>
                            </li>
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-link"><a href="<?php echo e(url(Session::get('lang').'/logout')); ?>"><i
                                    class="fas fa-sign-in-alt text-orange pe-2"></i><?php echo app('translator')->get('lang.log_out'); ?></a></li>
                        <?php else: ?>
                        <li class="nav-link"><a href="<?php echo e(url('/'.Session::get('lang'))); ?>"><i
                                    class="fas fa-home text-orange pe-2"></i><?php echo app('translator')->get('lang.home'); ?></a>
                        </li>
...
</script><?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/frontend/inc_navbar_scroll.blade.php ENDPATH**/ ?>