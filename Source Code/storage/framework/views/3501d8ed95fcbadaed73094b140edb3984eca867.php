...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <div class="text-right">
                                    <a href="<?php echo e(url('backend/admin/add-hotel')); ?>" class="btn btn-success "><i
                                    ...
                                    <table id="simpletable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php endif; ?>
                                                <?php if($check->page_edit == 1 || $check->page_view == 1 || $check->page_delete == 1): ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $partner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($key+1); ?></td>
                                                <td><?php echo e(@$u->firstname); ?> <?php echo e($u->lastname); ?></td>
                                                <td><?php echo e(@$u->email); ?></td>
                                                <td><?php echo e(@$u->address); ?></td>
                                                <td><?php echo e(@$u->phone1); ?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="btn btn-warning text-white"
                                                        href="<?php echo e(url('backend/Partner/Edit/'.$u->id)); ?>"> Edit <i
                                                            class="fa fa-user"></i></a>
                                                    <?php endif; ?>
                                                    <?php if($check->page_view == 1): ?>
                                                    <a disabled class="btn btn-info text-white"
                                                      onclick="alert_warn()"> Pool Villa<i
    ...
    <script>
        ...
        function alert_warn(){
            ...
            icon: 'error',
            title: 'ขออภัย...',
            text: 'ระบบยังไม่ได้อัพเดทเป็นฐานข้อมูลล่าสุด!',
            footer: 'ฟังก์ชันนี้กำลังได้รับการดำเนินการแก้ไข'
        })
        }
    </script>
</body>
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/backend/Partner/index.blade.php ENDPATH**/ ?>