...
<body>
    ...
    <div class="bg-orange">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                <div class="text-title text-bold text-white"><?php echo app('translator')->get('lang.fine_a_great_experience'); ?></div>
                <form id="formProvince" action="<?php echo e(url(Session::get('lang').'/select-hotel/search')); ?>" method="get" autocomplete="off">
                    <div class="autocomplete">
                        ...
                        <input type="hidden" name="ci" value="<?php echo e($ci); ?>">
                        <input type="hidden" name="co" value="<?php echo e($co); ?>">
    ...
    <div class="container">
                ...
                <div class="for-destop">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('lang.tourist_attraction'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        </div>
        <div class="head-text-index"><?php echo app('translator')->get('lang.top_destinations'); ?></div>
        ...
        <div class="row justify-content-center  my-5">
            ...
            <div class="col-sm-4 col-6">
                <div class="frame-item box-destination">
                    <a href="<?php echo e(url(Session::get('lang').'/tourist_attraction_province/search?id='.$val->district_code.'&province='.$province.'&district='.$district)); ?>" class="">
                        <img src="<?php echo e(($val->district_image != '')? asset('assets_frontend/images/'.$val->district_image) : asset('assets_frontend/images/destination1.jpg')); ?>" class="img-des">
                        <div class="bottom-left">
                            <p class="name-text text-white"><?php if(Session::get('lang') == 'en'): ?> <?php echo e($val->name_en); ?> <?php else: ?> <?php echo e($val->name_th); ?> <?php endif; ?> , <?php if(Session::get('lang') == 'en'): ?> <?php echo e($val->district_en); ?> <?php else: ?> <?php echo e($val->district_th); ?> <?php endif; ?></p>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="head-text-index"><?php echo app('translator')->get('lang.explore_more'); ?></div>
        <div class="line-bottom-head-text"></div>

        <div class="row my-5">
            <?php $__currentLoopData = $_provinces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($key+1 >= 4): ?>
            <?php
                if(Session::get('lang') == 'en'){
                    $province = $val->name_en;
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/frontend/tourist_attraction.blade.php ENDPATH**/ ?>