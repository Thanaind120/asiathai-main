...
<body>
    ...
    <div class="container">
                    ...
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">*<?php if(Session::get('lang') ==
                                'en'): ?><?php echo e($_province->name_en); ?><?php else: ?><?php echo e($_province->name_th); ?><?php endif; ?>*</li>
                        </ol>
                    </nav>
                </div>
            </div>
        </div>
        <div class="head-text-index"><?php echo app('translator')->get('lang.most_popular_cities_in'); ?> *<?php if(Session::get('lang') ==
            'en'): ?><?php echo e($_province->name_en); ?><?php else: ?><?php echo e($_province->name_th); ?><?php endif; ?>*</div>
        <div class="line-bottom-head-text"></div>
        <div class="row my-5">
            <?php $__currentLoopData = $_city; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="col-sm-4 col-6">
                <div class="frame-item box-destination">
                    <a href="<?php echo e(url(Session::get('lang').'/select-hotel/search?district='.$district.'&ci='.$ci.'&co='.$co.'&adult='.$adult.'&kid='.$kid.'&ro='.$ro)); ?>"
                        class="">
                        <img src="<?php echo e(($val->district_image != '')? asset('assets_frontend/images/'.$val->district_image) : asset('assets_frontend/images/destination1.jpg')); ?>"
                            class="img-des">
                        <div class="bottom-left">
                            <p class="name-text text-white"><?php if(Session::get('lang') == 'en'): ?>
                                <?php echo e($val->provinces_en); ?><?php else: ?> <?php echo e($val->provinces_th); ?><?php endif; ?>, <?php if(Session::get('lang')
        ...
        <div class="head-text-index"><?php echo app('translator')->get('lang.Top_picks_for_PoolVilla_in'); ?> *<?php if(Session::get('lang') ==
            'en'): ?><?php echo e($_province->name_en); ?><?php else: ?><?php echo e($_province->name_th); ?><?php endif; ?>*</div>
        <div class="line-bottom-head-text"></div>
        <!-- Recommend  slide -->
                ...
                <div class="">
                    <a
                        ...
                        <div class="box-save-red-image">
                            <?php $__currentLoopData = $discount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="text-head-sale"><?php echo e($val2->discount); ?>%</div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="small text-light-grey" style="text-decoration: line-through;">
                            <?php echo app('translator')->get('lang.from_normal'); ?> <?php echo e(number_format($val->price)); ?>฿
                        </div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/frontend/select-province.blade.php ENDPATH**/ ?>