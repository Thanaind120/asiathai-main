    ...
    <section class="section">
      ...
      <div class="section-body ">      
        <div class="card col-12" >             
          ...
          <form action="<?php echo e(url('Backend/Partner/Form1/save')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php if(!isset($list1)): ?>
      ...
      <input class="form-control mt-2" type="text" name="firstname" placeholder="name" value="<?php echo e(@$list1->firstname); ?>" required>
      </div>
      <div class="col-sm-6">
      <div class="text-tiny text-grey text-start mt-3"> Lastname </div>
      <input class="form-control mt-2" type="text" name="lastname" placeholder="input last name" value="<?php echo e(@$list1->lastname); ?>" required>
      </div>
      <div class="col-sm-4">
      <div class="text-tiny text-grey text-start mt-3"> email </div>
      <input class="form-control mt-2" type="text" name="email" placeholder="input email" value="<?php echo e(@$list1->email); ?>" required>
      </div>
      <div class="col-sm-4">
      <div class="text-tiny text-grey text-start mt-3"> Comission (%) </div>
      <input class="form-control mt-2" type="text" name="comission" placeholder="input number of percent" value="<?php echo e(@$list1->comission); ?>" required>
      </div>
      ...
      <div class="col-4">
              ...
              <input  type="date" class="form-control" name="birthday" value="<?php echo e(@$partner_detail->birthday); ?>" required>
            </div>
            <!-- <div class="col-4">
            ...
            <div class=" col-4">
              ...
              <input type="text" class="form-control" name="phone" required value="<?php echo e(@$list1->phone1); ?>">
            </div>
            <div class=" col-4">
              <label for="exampleFormControlInput3" class="form-label text-orange">Phone2</label>
              <input type="text" class="form-control" name="phone2"  value="<?php echo e(@$list1->phone2); ?>">
            </div>
            <div class=" col-4">
              <label for="exampleFormControlInput3" class="form-label text-orange">Address</label>
              <input type="text" class="form-control" name="address" required value="<?php echo e(@$list1->address); ?>">
            </div>
            <div class=" col-4">
            ...
            <option value="<?php echo e($l2->code); ?>"  <?php echo e(@$list1->district_id == $l2->code  ? 'selected ' : null); ?>   ><?php echo e($l2->name_en); ?></option>
            ...
            <option value="<?php echo e($l3->code); ?>" <?php echo e(@$list1->province_id == $l3->code  ? 'selected ' : null); ?>  ><?php echo e($l3->name_en); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          ...
          <div class="col-4">
            ...
            <input type="text" class="form-control" name="postal" id="postcode" value="<?php echo e(@$partner_detail->postal); ?>" required >
          </div>
          <div class=" col-4">
            ...
            <select name="ref_bank_id" class="form-control">
                ...
                <?php $__currentLoopData = $bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($b->id); ?>" <?php echo e(@$partner_bank->ref_bank_id==$b->id ?'selected' :''); ?>> <?php echo e($b->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div class="col-4">
            <label for="exampleFormControlInput3" class="form-label text-orange">สาขา</label>
            <input type="text" class="form-control" name="branch" required value="<?php echo e(@$partner_bank->branch); ?>" >
          </div>
          <div class=" col-4">
            <label for="exampleFormControlInput3" class="form-label text-orange">Account Name</label>
            <input type="text" class="form-control" name="acct_name"  required value="<?php echo e(@$partner_bank->acct_name); ?>" >
          </div>
          <div class=" col-4">
            <label for="exampleFormControlInput3" class="form-label text-orange">Account Number</label>
            <input type="text" class="form-control" name="acct_no" id="postcode" value="<?php echo e(@$partner_bank->acct_no); ?>" required>
          </div>
      </div>
...
<?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/backend/Partner/form1.blade.php ENDPATH**/ ?>