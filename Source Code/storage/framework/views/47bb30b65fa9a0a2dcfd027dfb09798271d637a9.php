                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control orange-check check-in-out" id="datepicker"
                                                type="text" placeholder="<?php echo app('translator')->get('lang.date'); ?>" name="ci" value="<?php echo e($today); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container">
            ...
            <div class="float-start">
                <div class="for-destop">
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="bread" href="<?php echo e(url('/')); ?>"><?php echo app('translator')->get('lang.home'); ?></a>
                            </li>
                            <?php
                                ...
                                $select_room = 1;
                            ?>
                            <li class="breadcrumb-item"><a class="bread" href="<?php echo e(url(Session::get('lang').'/select-hotel/search?province='.$province_name.'&ci='.$today.'&co='.$tomorrow.'&adult='.$adult.'&kid='.$kid.'&ro='.$select_room)); ?>">Select Hotel</a>
                            </li>
                            
                            <li class="breadcrumb-item"><a class="bread" href="<?php echo e(url(Session::get('lang').'/select-rooms/'.$poolvilla->id.'/'.$check_in.'/'.$check_out.'/adult='.$adult.'/kid='.$kid.'/room='.$select_room)); ?>">Select Rooms</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('lang.reviews'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="box-white">
            <div class="vl-bottom">
                <div class="row g-1">
                    <div class="col-auto">
                        <div class="text-title text-bold text-grey mb-2">
                            ...
                            <?php echo e($poolvilla->poolvilla_en); ?>

                            <?php else: ?>   
                            <?php echo e($poolvilla->poolvilla_th); ?> 
                            <?php endif; ?>
                        </div>
                    </div>&nbsp;
                    <div class="col-auto">
                        <div class="point-badge"><?php echo e($poolvilla->star_rating); ?></div>
                    </div>
                </div>
                <div class="">
                ...
                <div class="clearfix">
                    <div class="float-start">
                        <div class="text-medium text-bold textw-sort text-orange"><?php echo app('translator')->get('lang.reviews_from_customer'); ?>
                        </div>
                    </div>
            ...
            <div class="vl-bottom">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="text-blue text-title text-bold"><?php echo e($val->rating); ?></div>
                    ...
                    <div class="col-sm-8">
                        <div class="box-grey my-2">
                            <div class="clearfix">
                                <img src="<?php echo e(asset('assets_frontend/images/review.svg')); ?>"
                                    class="float-end reviewpage-icon">
                            </div>
                            <div class="text-medium text-grey p-3 mt-3"><?php echo e($val->review); ?></div>
                        </div>
                        <div class="row g-1">
                            <?php
                                $image = DB::table('db_image_review')->where('ref_review_id',$val->id)->get();
                            ?>
                            <?php $__currentLoopData = $image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-sm-3 col-6">
                                <div class="img-a">
                                    <img src="<?php echo e(asset(@$val2->image)); ?>" style="width:100%"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content popup-img">
                            <div class="modal-body">
                                ...
                                <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="<?php echo e(asset('assets_frontend/images/cities%20(1).jpg')); ?>"
                                                class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo e(asset('assets_frontend/images/cities%20(2).jpg')); ?>"
                                                class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo e(asset('assets_frontend/images/cities%20(3).jpg')); ?>"
                                                class="d-block w-100" alt="...">
                                        </div>
                                    </div>
                                ...
                                <div class="text-tiny text-grey text-end mt-1"><?php echo app('translator')->get('lang.all_pictures'); ?> (3)</div>
                            </div>
                        </div>
                    </div>
                </div>
...
</script><?php /**PATH /home/zkorn2/domains/korn2.orangeworkshop.info/public_html/Poolvilla/resources/views/frontend/review_hotel.blade.php ENDPATH**/ ?>